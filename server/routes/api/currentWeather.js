...
module.exports = async (req, res) => {
    ...
    try {
        let data = await axios.get(
            `https://api.openweathermap.org/data/2.5/weather?q=${city},${state},${req.params.country}&appid=${process.env.API_KEY}&units=metric&lang=pl`
        );
        ...
        let datetime = new Date(data.data.dt * 1000)
            .toLocaleString()
            .split(" ");
